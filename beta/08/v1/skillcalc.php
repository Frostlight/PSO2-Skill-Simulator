    ...
    <tr>
        <td width="100%">
            <div class="block">
                ...
                <br>
                <div class="content">
                    <h2>PSO2 Skill Simulator 3.0001.0 BETA v1 - <span style="color:red">DEPRECATED</span></h2>
                    <table width="100%">
                        <tr>
                                ...
                                <div class="content">
                                    ...
                                    <table style="width:95%"><tr><td>&nbsp;</td>
                                            <td><span class="t_38">Language (Game Version)</span><br>
                                                ...
                                                <br>
                                                <select id="sl_save">
                                                <option value="save01">Slot 1: Empty</option>
                                                <option value="save02">Slot 2: Empty</option>
                                                <option value="save03">Slot 3: Empty</option>
                                                <option value="save04">Slot 4: Empty</option>
                                                <option value="save05">Slot 5: Empty</option>
                                                <option value="save06">Slot 6: Empty</option>
                                                <option value="save07">Slot 7: Empty</option>
                                                <option value="save08">Slot 8: Empty</option>
                                                <option value="save09">Slot 9: Empty</option>
                                                <option value="save10">Slot 10: Empty</option>
                                                <option value="save11">Slot 11: Empty</option>
                                                <option value="save12">Slot 12: Empty</option>
                                                </select><br>
