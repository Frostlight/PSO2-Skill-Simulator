...
<table class="maintable">
    <tr>
        <td width="100%">
            <div class="block">
                <a href="http/query_79D3D2D5">&laquo; Home</a>
                <br>
                <div class="content">
                    <h2>PSO2 Skill Simulator</h2>
                    <table width="100%">
                        <tr>
                                ...
                                <div class="content">
                                    ...
                                    <table style="width:95%"><tr><td>&nbsp;</td>
                                            <td><span class="t_38">Language (Game Version)</span><br>
                                                ...
                                                &nbsp;┗<input type="checkbox" id="ch_detail" checked> <span class="t_46">Level Details</span><br>
                                                <br>
                                ...
                                <div class="content">
                                    ...
                                    <table>
                                        <tr>
                                            <td>&nbsp;</td><td>
                                                <ul class="tabrow">
                                                    <li id="tab0" class="selected" onclick="tab(0);"><div style="position:relative; width:16px; height:16px; top:2px; left:-2px; background-image:url('img/class0.png'); display: inline-block"></div><span class="t_5" id="l_tab0">Hunter</span></li>
                                                    <li id="tab1" class="unselected" onclick="tab(1);"><div style="position:relative; width:16px; height:16px; top:2px; left:-2px; background-image:url('img/class1.png'); display: inline-block"></div><span class="t_8" id="l_tab1">Fighter</span></li>
                                                    <li id="tab2" class="unselected" onclick="tab(2);"><div style="position:relative; width:16px; height:16px; top:2px; left:-2px; background-image:url('img/class2.png'); display: inline-block"></div><span class="t_6" id="l_tab2">Ranger</span></li>
                                                    <li id="tab3" class="unselected" onclick="tab(3);"><div style="position:relative; width:16px; height:16px; top:2px; left:-2px; background-image:url('img/class3.png'); display: inline-block"></div><span class="t_9" id="l_tab3">Gunner</span></li>
                                                    <li id="tab4" class="unselected" onclick="tab(4);"><div style="position:relative; width:16px; height:16px; top:2px; left:-2px; background-image:url('img/class4.png'); display: inline-block"></div><span class="t_7" id="l_tab4">Force</span></li>
                                                    <li id="tab5" class="unselected" onclick="tab(5);"><div style="position:relative; width:16px; height:16px; top:2px; left:-2px; background-image:url('img/class5.png'); display: inline-block"></div><span class="t_10" id="l_tab5">Techer</span></li>
                                                    <li id="tab6" class="unselected" onclick="tab(6);"><div style="position:relative; width:16px; height:16px; top:2px; left:-2px; background-image:url('img/class6.png'); display: inline-block"></div><span class="t_11" id="l_tab6">Braver</span></li>
                                                    <li id="tab7" class="unselected" onclick="tab(7);"><div style="position:relative; width:16px; height:16px; top:2px; left:-2px; background-image:url('img/class7.png'); display: inline-block"></div><span class="t_12" id="l_tab7">Bouncer</span></li>
                                                </ul>
                                                <div class="tabcontent" id="skilltree" style="width:1017px; height:905px; background-repeat: no-repeat;" onmousewheel="return false;"></div>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
